...
<head>
  <meta charset="utf-8">
  <title>Seja bem vindo à Galatea Casa</title>
  <link rel="stylesheet" type="text/css" href="<?php echo  assets_url('css/site/styles.css'); ?>">
...
<body class="product-page">
  ...
  <section class="header-main">
    ...
    <section class="grid_12 header-mid">
      <section class="grid_6 alpha" style="margin-bottom: 10px;">
        <h1 class="logo">
          <a href="<?php echo  site_url()?>"><img src="<?php echo  assets_url('images/logo.jpg'); ?>" width="461" height="41" alt="Galatea"></a>
        </h1>
      </section>
      <section class="grid_5 prefix_1 omega">
        <ul>
          <li>
            <span>&nbsp;</span>
          </li>
